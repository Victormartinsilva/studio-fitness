...
class Plano(models.Model):
    ...
    sessoes_por_semana = models.PositiveSmallIntegerField(null=True, blank=True)
    quantidade_sessoes = models.PositiveSmallIntegerField(null=True, blank=True)
    validade_dias = models.PositiveSmallIntegerField(null=True, blank=True)
    valor = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    ativo = models.BooleanField(default=True)
    tipos_sessao = models.ManyToManyField(TipoSessao, related_name="planos", blank=True)
...
class Contratacao(models.Model):
    ...
    sessoes_contratadas = models.PositiveSmallIntegerField(null=True, blank=True)
    sessoes_por_semana = models.PositiveSmallIntegerField(null=True, blank=True)
